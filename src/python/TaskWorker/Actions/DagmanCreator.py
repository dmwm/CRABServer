...
class DagmanCreator(TaskAction):
    ...
    def makeJobSubmit(self):
        ...
        #
        with open('/data/hostdisk/TaskWorker/groups/highPriorityUsers.json', 'r', encoding='utf-8') as fd:
            hiPrioUsers = json.load(fd)
    ...
    def createSubdag(self, splitterResult, **kwargs):
        ...
        self.task['numautomjobretries'] = getattr(self.config.TaskWorker, 'numAutomJobRetries', 3)
