...
class Task(object):
    ...
    New_sql = "INSERT INTO tasks ( \
              ...
              tm_save_logs, tw_name, tw_canary_name, tm_user_infiles, tm_maxjobruntime, tm_numcores, tm_maxmemory, tm_priority, \
              ...
              :save_logs, :tw_name, :tw_canary_name, :user_infiles, :maxjobruntime, :numcores, :maxmemory, :priority, \
