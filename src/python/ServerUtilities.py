...
STAGEOUT_ERRORS = {60317: [{"regex": ".*Cancelled ASO transfer after timeout.*",
                   ...
                   60322: [{"regex": ".*permission denied.*",
                            ...
                            "isPermanent": True},
                           {"regex": "^SOURCE .*Permission refused.*",
                            "error-msg": "Permission denied from source site.",
                            "isPermanent": True},
                           {"regex": "^DESTINATION .*Permission refused.*",
                            "error-msg": "Permission denied from destination site.",
                            "isPermanent": True},
                   ...
                   60326: [{"regex": "^SOURCE .*curl error \\(56\\).*",
                   ...
                   60327: [{"regex": "^DESTINATION .*HTTP 5(?!07)\\d\\d.*",
