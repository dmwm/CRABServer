...
STAGEOUT_ERRORS = {60317: [{"regex": ".*Cancelled ASO transfer after timeout.*",
                   ...
                   60321: [{"regex": ".*reports could not open connection to.*",
                           ...
                           {"regex": "^TRANSFER .*Copy failed \\(3rd pull\\).*curl error \\(35\\).*",
                            "error-msg": "Third-party pull failed: SSL connection error.",
                            "isPermanent": False},
                           {"regex": "^SOURCE\\b.*curl error \\(35\\).*",
                             "error-msg": "SSL connection error at source storage.",
                             "isPermanent": False},
                            {"regex": "^DESTINATION\\b.*curl error \\(35\\).*",
                             "error-msg": "SSL connection error at destination storage.",
                             "isPermanent": False},
                            {"regex": ".*curl error \\(35\\).*",
                             "error-msg": "SSL connection error.",
                             "isPermanent": False},
                           {"regex": "^SOURCE\\b.*curl error \\(7\\).*",
                             "error-msg": "Source storage unreachable.",
                             "isPermanent": False},
                            {"regex": "^DESTINATION\\b.*curl error \\(7\\).*",
                             "error-msg": "Destination storage unreachable.",
                             "isPermanent": False},
                            {"regex": ".*curl error \\(7\\).*",
                             "error-msg": "Storage element is unreachable.",
                             "isPermanent": False},
                           {"regex": "^SOURCE\\b.*curl error \\(28\\).*",
                             "error-msg": "Source storage did not respond in time, connection timeout.",
                             "isPermanent": False},
                            {"regex": "^DESTINATION\\b.*curl error \\(28\\).*",
                             "error-msg": "Destination storage did not respond in time, connection timeout.",
                             "isPermanent": False},
                            {"regex": ".*curl error \\(28\\).*",
                             "error-msg": "Storage element did not respond in time, connection timeout.",
                             "isPermanent": False},
                           {"regex": "^TRANSFER .*Copy failed \\(3rd pull\\).*curl error \\(52\\).*",
                             "error-msg": "Third-party pull failed: the destination storage accepted the COPY request but returned no response.",
                             "isPermanent": False},
                           {"regex": "^DESTINATION\\b.*curl error \\(52\\).*",
                             "error-msg": "Destination storage accepted the connection but returned empty response.",
                             "isPermanent": False},
                            {"regex": ".*curl error \\(52\\).*",
                             "error-msg": "Storage accepted the connection but returned empty response.",
                             "isPermanent": False},
                           ],
                   ...
                   60326: [{"regex": "^SOURCE .*curl error \\(56\\).*",
                            "error-msg": "Transfer interrupted while reading from the source storage.",
                            "isPermanent": False},
                           {"regex": "^DESTINATION .*curl error \\(56\\).*",
                            "error-msg": "Transfer interrupted while writing to the destination storage.",
                            "isPermanent": False},
                           {"regex": ".*curl error \\(56\\).*",
                            "error-msg": "Transfer interrupted.",
                            "isPermanent": False},
                           {"regex": ".*Connection terminated abruptly.*",
                            "error-msg": "Transfer interrupted due to Third-party-copy connection terminated abruptly.",
                            "isPermanent": False},
                           ],
                   60327: [{"regex": "^TRANSFER .*Copy failed \\(3rd pull\\).*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Unexpected server error while Third-party copy transfering",
                            "isPermanent": True},
                           {"regex": ".*Copy failed \\(3rd pull\\).*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Unexpected server error at Third-party copy.",
                            "isPermanent": True},
                           {"regex": "^SOURCE .*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Unexpected server error at source site.",
                            "isPermanent": True},
                           {"regex": "^DESTINATION .*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Unexpected server error at destination site.",
                            "isPermanent": True},
                           {"regex": "^.*HTTP .*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Unexpected server error.",
                            "isPermanent": True},
                           ],
                   60328: [{"regex": ".*curl error \\(3\\).*",
                            "error-msg": "Invalid or missing transfer URL (bad format).",
                            "isPermanent": True},
                           {"regex": ".*HTTP 404\\b.*",
                            "error-msg": "File not found. Source replica is missing, or the destination path does not exist.",
                            "isPermanent": True},
                           {"regex": ".*HTTP 429\\b.*",
                            "error-msg": "Storage is rate-limiting requests. FTS will retry with backoff.",
                            "isPermanent": False},
                           ],
}
