...
STAGEOUT_ERRORS = {60317: [{"regex": ".*Cancelled ASO transfer after timeout.*",
                   ...
                   60322: [{"regex": "^SOURCE .*Permission refused.*",
                            "error-msg": "Permission denied at source site.",
                            "isPermanent": True},
                           {"regex": "^DESTINATION .*Permission refused.*",
                            "error-msg": "Permission denied at destination site.",
                            "isPermanent": True},
                           {"regex": "^TRANSFER .*Permission refused.*",
                            "error-msg": "Permission denied while 3rd-party transfering.",
                            "isPermanent": True},
                           {"regex": ".*Permission refused.*",
                            "error-msg": "Permission denied.",
                            "isPermanent": True},
                           {"regex": "^SOURCE .*HTTP 40[13]\\b.*",
                            "error-msg": "Authentication or authorization failed at source site. Check proxy validity and VOMS role.",
                            "isPermanent": True},
                           {"regex": "^DESTINATION .*HTTP 40[13]\\b.*",
                            "error-msg": "Authentication or authorization failed at destination site. Check proxy validity and VOMS role.",
                            "isPermanent": True},
                           {"regex": "^TRANSFER .*HTTP 40[13]\\b.*",
                            "error-msg": "Authentication or authorization failed while Third-party copying. Check proxy validity, VOMS role, Site Configuration with Site Admins.",
                            "isPermanent": True},
                           {"regex": ".*HTTP 40[13]\\b.*",
                            "error-msg": "Authentication or authorization failed.",
                            "isPermanent": True},
                   ...
                   60325: [{"regex": ".*stayed in the queue for too long.*",
                            "error-msg": "FTS Transfer expired, reached maximum time in queue.",
                            "isPermanent": False},
                           ],
                   60326: [{"regex": "^SOURCE\\b.*curl error \\(3\\).*",
                            "error-msg": "Likely error at source RSE: Invalid or missing source URL (bad format).",
                            "isPermanent": True},
                           {"regex": "^SOURCE\\b.*curl error \\(7\\).*",
                            "error-msg": "Likely error at source RSE: Source storage unreachable.",
                            "isPermanent": False},
                           {"regex": "^SOURCE\\b.*curl error \\(28\\).*",
                            "error-msg": "Likely error at source RSE: Source storage did not respond in time, connection timeout.",
                            "isPermanent": False},
                           {"regex": "^SOURCE\\b.*curl error \\(35\\).*",
                            "error-msg": "Likely error at source RSE: SSL connection error at source storage.",
                            "isPermanent": False},
                           {"regex": "^SOURCE\\b.*curl error \\(52\\).*",
                            "error-msg": "Likely error at source RSE: Source storage accepted the connection but returned empty response.",
                            "isPermanent": False},{"regex": "^SOURCE .*curl error \\(56\\).*",
                                                   "error-msg": "Likely error at source RSE: Transfer interrupted while reading from the source storage.",
                                                   "isPermanent": False},
                           {"regex": "^SOURCE .*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Likely error at source RSE: Unexpected server error at source site.",
                            "isPermanent": False},
                           ],
                   60327: [{"regex": "^DESTINATION\\b.*curl error \\(3\\).*",
                            "error-msg": "Likely error at destination RSE: Invalid or missing destination URL (bad format).",
                            "isPermanent": True},
                           {"regex": "^DESTINATION\\b.*curl error \\(7\\).*",
                            "error-msg": "Likely error at destination RSE: Destination storage unreachable.",
                            "isPermanent": False},
                           {"regex": "^DESTINATION\\b.*curl error \\(28\\).*",
                            "error-msg": "Likely error at destination RSE: Destination storage did not respond in time, connection timeout.",
                            "isPermanent": False},
                           {"regex": "^DESTINATION\\b.*curl error \\(35\\).*",
                            "error-msg": "Likely error at destination RSE: SSL connection error at destination storage.",
                            "isPermanent": False},
                           {"regex": "^DESTINATION\\b.*curl error \\(52\\).*",
                            "error-msg": "Likely error at destination RSE: Destination storage accepted the connection but returned empty response.",
                            "isPermanent": False},
                           {"regex": "^DESTINATION .*curl error \\(56\\).*",
                            "error-msg": "Likely error at destination RSE: Transfer interrupted while writing to the destination storage.",
                            "isPermanent": False},
                           {"regex": "^DESTINATION .*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Likely error at destination RSE: Unexpected server error at destination site.",
                            "isPermanent": False},
                           ],
                   60328: [{"regex": "^TRANSFER .*Copy failed \\(3rd pull\\).*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Generic transfer failure: Unexpected server error while Third-party copy transfering",
                            "isPermanent": True},
                           {"regex": "^TRANSFER .*Copy failed \\(3rd pull\\).*curl error \\(35\\).*",
                            "error-msg": "Generic transfer failure: Third-party pull failed: SSL connection error.",
                            "isPermanent": False},
                           {"regex": "^TRANSFER .*Copy failed \\(3rd pull\\).*curl error \\(52\\).*",
                            "error-msg": "Generic transfer failure: Third-party pull failed: the destination storage accepted the COPY request but returned no response.",
                            "isPermanent": False},
                           {"regex": ".*Connection terminated abruptly.*",
                            "error-msg": "Generic transfer failure: Transfer interrupted due to Third-party-copy connection terminated abruptly.",
                            "isPermanent": False},
                           {"regex": ".*Copy failed \\(3rd pull\\).*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Generic transfer failure: Unexpected server error at Third-party copy.",
                            "isPermanent": False},
                           {"regex": ".*HTTP 404\\b.*",
                            "error-msg": "Generic transfer failure: File not found. Source replica is missing, or the destination path does not exist.",
                            "isPermanent": True},
                           {"regex": ".*HTTP 429\\b.*",
                            "error-msg": "Generic transfer failure: Storage is rate-limiting requests. FTS will retry with backoff.",
                            "isPermanent": False},
                           {"regex": "^.*HTTP .*HTTP 5(?!07)\\d\\d.*",
                            "error-msg": "Generic transfer failure: Unexpected server error.",
                            "isPermanent": False},
                           {"regex": ".*curl error \\(35\\).*",
                            "error-msg": "Generic transfer failure: SSL connection error.",
                            "isPermanent": False},
                           {"regex": ".*curl error \\(7\\).*",
                            "error-msg": "Generic transfer failure: Storage element is unreachable.",
                            "isPermanent": False},
                           {"regex": ".*curl error \\(28\\).*",
                            "error-msg": "Generic transfer failure: Storage element did not respond in time, connection timeout.",
                            "isPermanent": False},
                           {"regex": ".*curl error \\(52\\).*",
                            "error-msg": "Generic transfer failure: Storage accepted the connection but returned empty response.",
                            "isPermanent": False},
                           {"regex": ".*curl error \\(3\\).*",
                            "error-msg": "Generic transfer failure: Invalid or missing transfer URL (bad format).",
                            "isPermanent": False},
                           {"regex": ".*curl error \\(56\\).*",
                            "error-msg": "Generic transfer failure: Transfer interrupted.",
                            "isPermanent": False},
