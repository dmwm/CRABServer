...
STAGEOUT_ERRORS = {60317: [{"regex": ".*Cancelled ASO transfer after timeout.*",
                   ...
                   60321: [{"regex": ".*reports could not open connection to.*",
                           ...
                           {"regex": "^SOURCE\\b.*curl error \\(35\\).*",
                             "error-msg": "TLS handshake with the source storage failed. Transient - will retry.",
                             "isPermanent": False},
                            {"regex": "^DESTINATION\\b.*curl error \\(35\\).*",
                             "error-msg": "TLS handshake with the destination storage failed. Transient - will retry.",
                             "isPermanent": False},
                            {"regex": ".*curl error \\(35\\).*",
                             "error-msg": "TLS handshake with the storage failed. Transient - will retry.",
                             "isPermanent": False},
