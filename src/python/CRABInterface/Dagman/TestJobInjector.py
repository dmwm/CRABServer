...
class TestJobInjector:
    ...
    def getDummyArgs(self):
        ...
        return {'runs': [], 'workflow': self.workflowString, 'cacheurl': 'https://voatlas294.cern.ch:25443', 'publishname': 'MyReskimForTwo-c6bdfb160b2ee3ff6d8128351c7e995c', 'savelogsflag': 1, 'userisburl': 'https://voatlas294.cern.ch:25443', 'vogroup': '/cms', 'userdn': '/DC=org/DC=doegrids/OU=People/CN=Andrew Malone Melo 788499', 'vorole': 'cmsuser', 'tfileoutfiles': [], 'asyncdest': 'T2_US_Nebraska', 'algoargs': 500, 'lumis': [], 'sitewhitelist': [], 'totalunits': 0, 'cachefilename': '8b578f03-677e-4808-81e4-3d44cd60bdd2default.tgz', 'siteblacklist': [], 'jobarch': 'slc5_amd64_gcc462', 'blockwhitelist': [], 'publication': 0, 'blockblacklist': [], 'splitalgo': 'LumiBased', 'publishdbsurl': '', 'jobsw': 'CMSSW_5_3_2', 'dbsurl': 'http://cmsdbsprod.cern.ch/cms_dbs_prod_global/servlet/DBSServlet', 'addoutputfiles': [], 'edmoutfiles': ['dumper.root'], 'adduserfiles': [], 'userhn': 'meloam', 'inputdata': '/GenericTTbar/HC-CMSSW_5_3_1_START53_V5-v1/GEN-SIM-RECO', 'jobtype': 'Analysis', 'testSleepMode' : True }
