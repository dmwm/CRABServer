...
class RESTUserWorkflow(RESTEntity):
    ...
    def __init__(self, app, api, config, mount):
        ...
        self.ASOinstance= config.asourl
        self.hostkey = config.serverhostkey
        self.hostcert = config.serverhostcert
    ...
    def post(self, workflow, siteblacklist, sitewhitelist, jobids, objects):
        ...
        return self.userworkflowmgr.resubmit(workflow=workflow, siteblacklist=siteblacklist, sitewhitelist=sitewhitelist, \
                                             jobids=jobids, ASOinstance=self.ASOinstance, objects=objects, \
                                             userdn=cherrypy.request.headers['Cms-Authn-Dn'], hostkey=self.hostkey, hostcert=self.hostcert)
    ...
    def delete(self, workflow, force, jobids, objects):
        ...
        return self.userworkflowmgr.kill(workflow, force, jobids, self.ASOinstance, objects, userdn=cherrypy.request.headers['Cms-Authn-Dn'], \
                                         hostkey=self.hostkey, hostcert=self.hostcert)
