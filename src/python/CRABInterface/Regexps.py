...
RX_SUBRES_TASK = re.compile(r"^(allinfo|allusers|summary|search|taskbystatus|taskbyddmreqid|getpublishurl|addwarning|deletewarnings|addwebdir|addoutputdatasets|addddmreqid|webdir|webdirprx|counttasksbystatus|counttasksbyuserandstatus|lastfailures|updateschedd|updatepublicationtime)$")
