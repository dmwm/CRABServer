...
cp $MYTESTAREA/$SCRAM_ARCH/cms/crabtaskworker/$RELEASE/data/script/Deployment/Publisher/{run.sh,start.sh,env.sh,stop.sh,} /data/srv/Publisher/
cp $MYTESTAREA/$SCRAM_ARCH/cms/crabtaskworker/$RELEASE/data/script/Deployment/TaskWorker/{run.sh,start.sh,env.sh,stop.sh,updateTMRuntime.sh} /data/srv/TaskManager/
